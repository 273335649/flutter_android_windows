...
void main() async {
  ...
  if (Platform.isAndroid) {
    ...
    try {
      ...
      if (baseUrl.isEmpty) {
        print('Base URL is not set. Skipping auto-updater setup.');
        return;
      }
      String feedURL =
          '$baseUrl/mes-biz/ota/versionByFlutter?appName=JJ3-MES-CLIENT';
      print('printfeedURL:$feedURL');
