...
class _LoginState extends State<Login> {
  ...
  void initState() {
    ...
    if (Constant.isDev) {
      ...
      // TODO
      // username.text = 'chendongqing';
      // password.text = 'KkRK3YYn';
      // username.text = '15823596020';
      // password.text = 'L3mC52tO';
    }
    super.initState();
    _checkAutoLogin();
...
class _LoginBtnState extends State<LoginBtn> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> loginBtnClick() async {
      ...
      loginFetch2.then((res) async => {loginThen(res)});
      // }
      // widget.changeToken();
    }
  ...
  return SizedBox(
    ...
    child: TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIconConstraints: BoxConstraints(maxWidth: 44.w, maxHeight: 24.w),
        hintText: '请输入账号',
    ...
    child: TextFormField(
      ...
      decoration: InputDecoration(
        prefixIcon: Padding(
          padding: EdgeInsets.only(left: 10.w),
          child: Image(
            image: AssetImage('images/scan-icon.png'),
            width: 26.w,
            height: 26.w,
          ),
        ),
        prefixIconConstraints: BoxConstraints(maxWidth: 44.w, maxHeight: 26.w),
        hintText: '扫码登录',
        hintStyle: TextStyle(color: Color(0xffC1D3FF)),
        border: _outlineInputBorder,
        focusedBorder: _outlineInputBorder,
  ...
  return SizedBox(
    ...
    child: TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIconConstraints: BoxConstraints(maxWidth: 44.w, maxHeight: 23.w),
        hintText: '请输入登录密码',
        hintStyle: TextStyle(color: Color(0xffC1D3FF)),
        border: _outlineInputBorder,
        focusedBorder: _outlineInputBorder,
