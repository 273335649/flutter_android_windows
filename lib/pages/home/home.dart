...
// import '../../component/webview_component_home.dart';
import '../../component/webview_component_input.dart';
  ...
  void _refreshPage() {
    ...
    if (isH5) {
      _webViewKey.currentState?.reloadWebView(
        localStorageData: LoginPrefs.getUserInfo(),
       );
    } else {
      setState(() {});
    }
        ...
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              RealTimeClock(),
              Text(
                ' |   登录人：${userinfo['username']}   |   产线：${userinfo['lineName'] ?? '-'}   工位：${userinfo['stationName'] ?? '-'}',
              ...
              InkWell(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.refresh, size: 14.sp, color: Color(0xFF3A6FCE)),
                    Text(
                      '刷新',
                      style: TextStyle(
  ...
  Widget build(BuildContext context) {
    ...
    if (isH5) {
      ...
      if (_webViewInstance == null || _lastH5Index != activeIndex) {
        ...
        final token = LoginPrefs.getToken();
